...
const protectedRoutesForAdminAndManagement = ['/reports']; // Add '/reports' route here
...
export async function middleware(request: NextRequest) {
  ...
  if (!protectedRoutes.includes(pathname) && !protectedRoutesForAdminAndManagement.includes(pathname)) {
